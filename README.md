...
See the [intensity conventions](https://github.com/diogovalada/pyscf-vscf/blob/v0.2.1/docs/intensity-conventions.md),
[installation guide](https://github.com/diogovalada/pyscf-vscf/blob/v0.2.1/docs/installation.md), and
[validation guide](https://github.com/diogovalada/pyscf-vscf/blob/v0.2.1/docs/running-validations.md)
for details.

The evolving coordinate, fitted n-mode, triatomic `J=0`, VCI, and vector-DMS
interfaces are documented in the
[advanced n-mode and VCI guide](https://github.com/diogovalada/pyscf-vscf/blob/v0.2.1/docs/nmode-vci.md).
