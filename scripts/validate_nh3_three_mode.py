...
def _write_manifest(data_root: Path, report_path: Path) -> None:
    ...
    manifest = {
        ...
        "regeneration_command": (
            "uv run --extra pyscf python scripts/generate_nh3_three_mode.py --npts 25 "
            "--workers 8 --threads-per-worker 1 && uv run --extra pyscf python "
            "scripts/generate_nh3_three_mode.py --npts 31 --workers 8 "
            "--threads-per-worker 1 && uv run --extra pyscf python "
